...
- [Google_Sheet](https://docs.google.com/spreadsheets/d/1i1sQ1SFxLjceR7di4Ji-U4JI4nBszTkC4fEfIF4BVoo/edit?usp=sharing)

## IMPORTANT:

The chatbot integration will not function on the public Webflow link or external devices. The frontend script attempts to contact localhost:5678, which is only accessible on the developer's machine.
